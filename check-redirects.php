...
require_once __DIR__ . '/../base/secure-inputs.php';
require_once __DIR__ . '/../base/framework.php';
...
<body>
			...
			<nav class="grey darken-4">
				<div class="nav-wrapper">
					...
					<ul class="right hide-on-med-and-down">
						...
						<!-- <li><a href="#!" class="tooltipped" data-position="bottom" data-tooltip="Menu"><i class="material-icons">more_vert</i></a></li> -->
					</ul>
				...
				<form class="col s12" id="check-form" method="GET">
					<div class="row">
						<div class="input-field col s12">
							<input type="text" id="check_host" name="q" class="validate" placeholder="Enter hostname (eg: http(s)://example.com)" value="<?php echo (isset($_GET['q']) ? $_GET['q'] : ''); ?>" required autofocus>
	...
	<script type="text/javascript" id="he-js" src="https://cdnjs.cloudflare.com/ajax/libs/he/1.2.0/he.min.js"></script>
